...
class _$ExpenseModelImpl implements _ExpenseModel {
  ...
  @override
  String toString() {
    return 'ExpenseModel(id: $id, groupId: $groupId, description: $description, amount: $amount, paidBy: $paidBy, category: $category, date: $date, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, groupId, description, amount,
      paidBy, category, date, createdAt, updatedAt);
...
abstract class _ExpenseModel implements ExpenseModel {
  const factory _ExpenseModel(
      ...
      final DateTime? createdAt,
      final DateTime? updatedAt}) = _$ExpenseModelImpl;
