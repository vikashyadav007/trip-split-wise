...
abstract class $BalanceModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, String userName, double balance});
}
...
class _$BalanceModelImpl implements _BalanceModel {
  ...
  @override
  String toString() {
    return 'BalanceModel(userId: $userId, userName: $userName, balance: $balance)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, userName, balance);
...
abstract class _BalanceModel implements BalanceModel {
  const factory _BalanceModel(
      ...
      required final double balance}) = _$BalanceModelImpl;
